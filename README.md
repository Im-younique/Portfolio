...
2024/06 - 자격증 취득 업데이트  
2024/10 - 경력 업데이트  
2025/04 - About me 보강 및 만료 링크 정리 (v1.0.4)  
2025/07 - Node 버전 업그레이드 (v1.0.5)  
2026/03 - Next.js 16 · React 19 업그레이드, 상태관리 Recoil → Context 전환 (v1.1.0)  
2026/06 - 프로젝트 섹션 개편 및 첫잔(FirstDrink) 추가 (v1.1.2)  
2026/07 - 신규 사이드 프로젝트 Lamina · RAINMAKER 추가 및 큐레이션 개편 (v1.1.3)
